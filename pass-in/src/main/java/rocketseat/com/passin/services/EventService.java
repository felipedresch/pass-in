...
public class EventService {
    ...
    //Garante que o participante ainda não está cadastrado no evento e que o evento existe
    public AttendeeIdDTO registerAttendeeOnEvent(String eventId, AttendeeRequestDTO attendeeRequestDTO){
        ...
        if(event.getMaximumAttendees() <= attendeeList.size()) throw new EventFullException("Event is already full");
